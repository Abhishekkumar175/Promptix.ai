  ...
  return (
    <div className="h-full flex flex-col pt-4 overflow-hidden">
      ...
      <div className="px-4 pb-4">
        ...
        >
          <div className="absolute inset-0 bg-linear-to-r from-violet-600/20 to-indigo-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        {chats.map((chat) => {
          ...
          return (
            ...
            >
              ...
              {/* Trash Icon (Visible on hover or active) */}
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  onDelete(chat.id);
