  ...
  return (
    <div className="h-full w-full bg-[#030712] text-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-lg">
        ...
        <h1 className="text-3xl font-bold tracking-tight mb-4">Mock Interview Bot</h1>
        <p className="text-gray-400 mb-8 leading-relaxed">
          Upload your resume and the targeted job role, and our AI will conduct a hyper-realistic behavioral and technical interview.
        </p>
